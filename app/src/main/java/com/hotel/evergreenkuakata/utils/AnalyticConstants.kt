...
object ScreenNameConstants {
    ...
    const val appScreenGenerateBillNotifyUserBottomSheet =
        "app_screen_generate_bill_notify_user_dialog"
    const val appScreenGenerateBillMarkAsPaidBottomSheet =
        "app_screen_generate_bill_mark_as_paid_dialog"
    const val appScreenGenerateBillPartialPaymentStatusBottomSheet =
        "app_screen_generate_bill_partial_payment_dialog"
}
...
object ButtonActionConstants {
    ...
    const val actionHomeReview = "action_home_app_review"
